...
ccboard.shared.model.move_event.MoveEvent.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__7359__auto__,k10151,else__7360__auto__){
var self__ = this;
var this__7359__auto____$1 = this;
var G__10153 = (((k10151 instanceof cljs.core.Keyword))?k10151.fqn:null);
switch (G__10153) {
case "piece":
return self__.piece;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k10151,else__7360__auto__);
...
ccboard.shared.model.move_event.MoveEvent.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__10150){
var self__ = this;
var G__10150__$1 = this;
return (new cljs.core.RecordIter((0),G__10150__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"piece","piece",1396691784),new cljs.core.Keyword(null,"movement-data","movement-data",-314283653)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
ccboard.shared.model.move_event.MoveEvent.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__7364__auto__,k__7365__auto__,G__10150){
var self__ = this;
var this__7364__auto____$1 = this;
var pred__10154 = cljs.core.keyword_identical_QMARK_;
var expr__10155 = k__7365__auto__;
if(cljs.core.truth_(pred__10154.call(null,new cljs.core.Keyword(null,"piece","piece",1396691784),expr__10155))){
return (new ccboard.shared.model.move_event.MoveEvent(G__10150,self__.movement_data,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10154.call(null,new cljs.core.Keyword(null,"movement-data","movement-data",-314283653),expr__10155))){
return (new ccboard.shared.model.move_event.MoveEvent(self__.piece,G__10150,self__.__meta,self__.__extmap,null));
} else {
return (new ccboard.shared.model.move_event.MoveEvent(self__.piece,self__.movement_data,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__7365__auto__,G__10150),null));
}
}
});
...
ccboard.shared.model.move_event.MoveEvent.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__7356__auto__,G__10150){
var self__ = this;
var this__7356__auto____$1 = this;
return (new ccboard.shared.model.move_event.MoveEvent(self__.piece,self__.movement_data,G__10150,self__.__extmap,self__.__hash));
});
...
ccboard.shared.model.move_event.map__GT_MoveEvent = (function ccboard$shared$model$move_event$map__GT_MoveEvent(G__10152){
return (new ccboard.shared.model.move_event.MoveEvent(new cljs.core.Keyword(null,"piece","piece",1396691784).cljs$core$IFn$_invoke$arity$1(G__10152),new cljs.core.Keyword(null,"movement-data","movement-data",-314283653).cljs$core$IFn$_invoke$arity$1(G__10152),null,cljs.core.dissoc.call(null,G__10152,new cljs.core.Keyword(null,"piece","piece",1396691784),new cljs.core.Keyword(null,"movement-data","movement-data",-314283653)),null));
});

ccboard.shared.model.move_event.create = (function ccboard$shared$model$move_event$create(var_args){
var args10158 = [];
var len__7843__auto___10161 = arguments.length;
var i__7844__auto___10162 = (0);
while(true){
if((i__7844__auto___10162 < len__7843__auto___10161)){
args10158.push((arguments[i__7844__auto___10162]));

var G__10163 = (i__7844__auto___10162 + (1));
i__7844__auto___10162 = G__10163;
continue;
} else {
}
break;
